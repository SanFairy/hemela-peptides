  ...
  return (
    ...
    >
      <div className="h-48 bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-primary-900/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
        <FaFlask className="text-6xl text-primary-300 group-hover:scale-110 transition-transform duration-300" />
        {p.featured && (
          <span className="absolute top-3 right-3 bg-gradient-to-r from-primary-600 to-primary-700 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
            {t('Featured', '精选')}
          </span>
        )}
      </div>
